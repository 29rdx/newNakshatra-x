      ...
      <div className="relative mx-auto max-w-7xl space-y-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/10 pb-4">
          <div className="flex items-center gap-2 text-xs font-mono text-[#38BDF8]">
            ...
            <span>/</span>
            <span className="text-[#FB923C] font-bold">Feature Page 02: ML Architecture & Training Studio</span>
          </div>
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-mono transition-all cursor-pointer ${
                  selectedMine.id === m.id
                    ? 'bg-gradient-to-r from-[#FB923C] to-[#FACC15] text-black font-extrabold shadow-[0_0_15px_rgba(251,146,60,0.5)]'
        ...
        <div className="space-y-8">
          <div className="flex items-center gap-2">
            <Cpu className="text-[#FB923C]" size={20} />
        ...
        <div className="p-4 rounded-2xl bg-[#060C1B]/95 border border-white/20 backdrop-blur-2xl shadow-2xl flex flex-col sm:flex-row items-center justify-between gap-4 mt-12">
          ...
          <Link
            href="/mine-twin"
            className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#00FF88]/25 via-[#00E5FF]/20 to-[#38BDF8]/25 hover:from-[#00FF88]/40 hover:to-[#38BDF8]/40 text-white font-mono text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2.5 transition-all duration-300 cursor-pointer border border-[#00FF88]/60 hover:border-[#00E5FF] shadow-[0_0_18px_rgba(0,255,136,0.25)] hover:shadow-[0_0_30px_rgba(0,255,136,0.6)] backdrop-blur-xl hover:scale-[1.02] active:scale-[0.98]"
          >
            <span className="font-extrabold text-white drop-shadow-[0_0_8px_rgba(0,255,136,0.6)]">Page 3: Mine Twin Simulator</span>
            <ArrowRight size={15} className="text-[#00FF88]" />
          </Link>
        </div>
      </div>
    </main>
