...
export default function MineTwinPanel({ selectedMine = DEFAULT_MINE }: Props) {
  ...
  return (
    <div id="mine-twin-container" className="space-y-8">
      {/* SECTION 1: 50-YEAR HISTORICAL DATA & 2040 AI PREDICTION VISUALIZER */}
      <div>
        <HistoricalForecastGlassVisualizer />
      </div>

      {/* SECTION 2: 3D DIGITAL TWIN & WHAT-IF OPERATIONAL SIMULATOR */}
