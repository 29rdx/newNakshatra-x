...
export function LoginForm() {
  ...
  // UI State
  const [loading, setLoading] = useState<'send_otp' | 'verify_otp' | 'guest' | 'google' | null>(null)
    ...
    <GlassCard className="w-full max-w-[500px] p-6 sm:p-8 text-center relative border border-white/15 shadow-[0_0_50px_rgba(0,0,0,0.85)]">
      ...
      <div className="mb-6 flex flex-col items-center">
        ...
        <p className="mt-1 text-xs text-slate-400 max-w-xs">
          Enter your email to receive a 6-digit code in your inbox, then submit the code below to log in.
        </p>
      </div>
